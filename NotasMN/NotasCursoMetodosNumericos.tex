...
\fancyhead[L]{\small M\'etodos Num\'ericos}
...
%===========================================
\title{Notas de M\'etodos Num\'ericos}
...
\begin{titlepage}
  ...
  \begin{center}
    ...
    {\huge \textbf{Notas de M\'etodos Num\'ericos}\par}
    \vspace{0.8cm}
...
\input{NotasSobreCurso}
\newpage

\input{NotasSistemasPuntoFlotante}
\newpage

\input{NotasSistemasEcuacionesLineales}
\newpage

\input{NotasRaicesFunciones}
\newpage

\input{NotasInterpolacion}
\newpage

\input{NotasSolucionNumericaEDO}
\newpage

\input{NotasTareas}
\newpage

\input{NotasIntroduccionR}
\newpage
